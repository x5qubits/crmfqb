...
<span class="dropdown-item dropdown-header" id="notification-header">0 Notificări</span>
<div class="dropdown-divider"></div>
		...
		<li class="nav-header">Start</li>
          <li class="nav-item <?=($pageId == 0 ? "nav-item menu-is-opening menu-open":"")?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./" class="nav-link <?=($pageIds == 10 ? "active":"")?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Financiar</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./dashboard" class="nav-link <?=($pageIds == 11 ? "active":"")?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Evenimente</p>
                </a>
              </li>
		  ...
		  <li class="nav-header">Gestionare</li>
          <li class="nav-item ">
		  ...
		  <li class="nav-item">
            <a href="calendar" class="nav-link <?=($pageId == 7 ? "active":"")?>">
		  ...
		  <li class="nav-item">
            <a href="campaigns" class="nav-link <?=($pageId == 8 ? "active":"")?>">
